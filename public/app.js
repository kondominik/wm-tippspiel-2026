...
window.adminPart=async(id)=>{await api('/api/admin/participant',{method:'POST',headers:{'x-admin-password':adminPass},body:JSON.stringify({id,name:$('pn'+id).value,pin:$('pp'+id).value})}); alert('Teilnehmer gespeichert')};
